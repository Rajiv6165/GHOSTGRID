...
if __name__ == "__main__":
    # Test with the real UUID board ID we just created
    board_id = "f35bc4ca-c831-468a-a2ff-6224184dff61"
    print(f"Testing WebSocket connection with real board ID: {board_id}")
